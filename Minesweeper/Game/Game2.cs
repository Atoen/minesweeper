...
{
    private static TilesGridOld _tilesGridOld = null!;
    ...
    public static void Start(DifficultyPreset preset)
    {
        ...
        // _tilesGrid = new TilesGrid(preset);
        //
        // _tilesGrid.BombClicked += OnBombClicked;
        // _tilesGrid.Flagged += ChangeFlagCount;
